...
const { addMovie, addActor, removeActor, listMovies, filterMovies, updateMovie, deleteMovie } = require("./movie/movieMethods");
...
const app = async (args) => {
  switch (process.argv[2]) {
    ...
    case "add actor":
      ...
      break;
    case "remove actor":
      removeActor(process.argv[3], process.argv[4]);
      break;
    case "list":
      listMovies();
      break;
